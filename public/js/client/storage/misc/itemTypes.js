...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemTypes.vue":
    ...
    methods: {
        createType: function createType() {
            ...
            if (self.formObject.code && self.formObject.name) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/itemType', self.formObject).then(function (res) {
        ...
        attemptUpdateType: function attemptUpdateType(index) {

            var self = this;
            self.itemTypes[index].editing = true;
        },
        saveUpdateType: function saveUpdateType(code, index) {

            var self = this;

            var typeName = $('input[name="' + 'typeName' + code + '"]').val();

            if (typeName) {

                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/update/itemType', { code: code, name: typeName }).then(function (res) {
        ...
        deleteType: function deleteType(code, index) {
            var self = this;
            if (code) {
                if (confirm('Are you sure you want to delete this type?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/itemType', { code: code }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteType: function undoDeleteType(code, index) {
            var self = this;
            if (code) {
                if (confirm("Undo delete this type?")) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/itemType', { code: code }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-3b6a4780\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemTypes.vue":
/***/ (function(module, exports, __webpack_require__) {
    ...
    _c("div", { staticClass: "row" }, [
                        ...
                        _c(
                          ...
                          _vm._l(_vm.itemTypes, function(type, index) {
                            return _c(
                              "tr",
                              {
                                staticClass: "filter-item-types",
                                class: { "bg-danger-lighter": type.isDeleted }
                              },
                              [
                                _c("td", [_vm._v(_vm._s(type.code))]),
                                _vm._v(" "),
                                _c("td", [
                                  !type.editing
                                        ...
                                        _c("i", {
                                          ...
                                          on: {
                                            click: function($event) {
                                              _vm.deleteType(type.code, index)
                                            }
                                          }
                                        }),
                                        _vm._v(
      ...
      _c("div", { staticClass: "col-lg-4 m-b-10" }, [
        _c("div", { staticClass: "card card-bordered" }, [
          _c("div", { staticClass: "card-block" }, [
            _c("form", { attrs: { id: "item-type-form" } }, [
              _c("h4", [_vm._v("Item Type Form")]),
              _vm._v(" "),
              _c("div", { staticClass: "row" }, [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3b6a4780", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainItemTypes.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemTypes.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-3b6a4780\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemTypes.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainItemTypes.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3b6a4780", Component.options)
  } else {
    hotAPI.reload("data-v-3b6a4780", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/itemTypes.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainItemTypes_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainItemTypes.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainItemTypes_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainItemTypes_vue__);
/**
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: { MainItemTypes: __WEBPACK_IMPORTED_MODULE_1__MainItemTypes_vue___default.a }
});
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/itemTypes.js");
