...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainShipments.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        //get shipments data
        Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["g" /* get */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/shipment/list').then(function (res) {
    ...
    methods: {
        createShipment: function createShipment() {
            var self = this;
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/shipment', self.formObject).then(function (res) {
                if (!res.data.isFailed) {
        ...
        attemptUpdateShipment: function attemptUpdateShipment(index) {
            var self = this;
        ...
        deleteShipment: function deleteShipment(id, index) {
            var self = this;
            if (id) {
                if (confirm('Are you sure to delete this shipment?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/shipment', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteShipment: function undoDeleteShipment(id, index) {
            var self = this;
            if (id) {
                if (confirm('Undo delete this shipment?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/shipment', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-6d8776f3\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainShipments.vue":
/***/ (function(module, exports, __webpack_require__) {
    ...
    _c("div", { staticClass: "row" }, [
                      ...
                      [
                        ...
                        _c(
                          ...
                          _vm._l(_vm.shipments, function(shipment, index) {
                            return _c(
                              "tr",
                              { staticClass: "filter-item-shipments" },
                              [
                                ...
                                _c("td", [
                                  !shipment.editing
                                    ? _c("span", [
                                        _vm._v(_vm._s(shipment.website))
                                      ])
                                    : _c("input", {
                                        staticClass: "form-control",
                                        attrs: {
                                        ...
                                        domProps: { value: shipment.website }
                                      })
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !shipment.editing
                                    ? _c("span", [
                                        _vm._v(_vm._s(shipment.callCenter))
                                      ])
                                    : _c("input", {
                                        staticClass: "form-control",
                                        attrs: {
                                          name:
                                            "shipmentCallCenter" + shipment.id,
                                          type: "text"
                                        },
                                        domProps: { value: shipment.callCenter }
                                      })
                                ]),
                                _vm._v(" "),
                                _c("td", [
      ...
      _c("div", { staticClass: "col-lg-4 m-b-10" }, [
        _c("div", { staticClass: "card card-bordered" }, [
          _c("div", { staticClass: "card-block" }, [
            _c("form", { attrs: { id: "shipment-form" } }, [
              _c("h4", [_vm._v("Shipments Form")]),
              _vm._v(" "),
              _c("div", { staticClass: "row" }, [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formObject.website,
                          expression: "formObject.website"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", required: "" },
                      domProps: { value: _vm.formObject.website },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formObject.callCenter,
                          expression: "formObject.callCenter"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", required: "" },
                      domProps: { value: _vm.formObject.callCenter },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
  ...
  function() {
    ...
    return _c("thead", { staticClass: "bg-master-lighter" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Website")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Call Center")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6d8776f3", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainShipments.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainShipments.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-6d8776f3\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainShipments.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainShipments.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d8776f3", Component.options)
  } else {
    hotAPI.reload("data-v-6d8776f3", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/shipments.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainShipments_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainShipments.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainShipments_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainShipments_vue__);
/**
...
var app = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    ...
    components: { MainShipments: __WEBPACK_IMPORTED_MODULE_1__MainShipments_vue___default.a }
});

$(document).ready(function () {
    $('.filter-container').sieve({
        searchInput: $('#search-shipments-box'),
        itemSelector: ".filter-item-shipments"
    });
});
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/shipments.js");
