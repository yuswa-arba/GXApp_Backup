...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainSuppliers.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        //get countries list
        Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["g" /* get */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'component/list/countries').then(function (res) {
            self.countries = res.data.data;
        });

        //get suppliers list
        Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["g" /* get */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/supplier/list').then(function (res) {
    ...
    methods: {
        insertSupplierLogo: function insertSupplierLogo(e) {
            var self = this;
        ...
        createSupplier: function createSupplier() {
            ...
            if (self.formObject.name && self.formObject.address && self.formObject.country && self.formObject.city && self.formObject.postalCode && self.formObject.telephoneNumber) {
                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/supplier', Object(__WEBPACK_IMPORTED_MODULE_2__helpers_utils__["b" /* objectToFormData */])(self.formObject)).then(function (res) {
                    if (!res.data.isFailed) {
        ...
        attemptUpdateSupplier: function attemptUpdateSupplier(index) {
            var self = this;
            self.suppliers[index].editing = true;
        },
        saveUpdateSupplier: function saveUpdateSupplier(id, index) {

            var self = this;

            var supplierName = $('input[name="' + 'supplierName' + id + '"]').val();
            var supplierAddress = $('input[name="' + 'supplierAddress' + id + '"]').val();
            var supplierCity = $('input[name="' + 'supplierCity' + id + '"]').val();
            var supplierPostalCode = $('input[name="' + 'supplierPostalCode' + id + '"]').val();
            var supplierCountry = $('select[name="' + 'supplierCountry' + id + '"]').val();
            var supplierTelNumber = $('input[name="' + 'supplierTelNumber' + id + '"]').val();
            var supplierContactPerson1 = $('input[name="' + 'supplierContactPerson1' + id + '"]').val();
            var supplierMobileNumber1 = $('input[name="' + 'supplierMobileNumber1' + id + '"]').val();
            var supplierEmail1 = $('input[name="' + 'supplierEmail1' + id + '"]').val();
            var supplierContactPerson2 = $('input[name="' + 'supplierContactPerson2' + id + '"]').val();
            var supplierMobileNumber2 = $('input[name="' + 'supplierMobileNumber2' + id + '"]').val();
            var supplierEmail2 = $('input[name="' + 'supplierEmail2' + id + '"]').val();
            var supplierAccNumber = $('input[name="' + 'supplierAccNumber' + id + '"]').val();
            var supplierNotes = $('input[name="' + 'supplierNotes' + id + '"]').val();

            if (supplierName && supplierAddress && supplierCountry && supplierCity && supplierPostalCode && supplierTelNumber) {

                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/update/supplier', {
                    id: id,
                    name: supplierName,
        ...
        deleteSupplier: function deleteSupplier(id, index) {
            var self = this;
            if (id) {
                if (confirm('Are you sure to delete this supplier?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/supplier', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteSupplier: function undoDeleteSupplier(id, index) {
            var self = this;
            if (id) {
                if (confirm('Undo delete this supplier?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/supplier', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-0f8c3e01\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainSuppliers.vue":
/***/ (function(module, exports, __webpack_require__) {
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.address,
                              expression: "formObject.address"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.address },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.formObject.country,
                                expression: "formObject.country"
                              }
                            ],
                            staticClass: "form-control",
                            attrs: { name: "", id: "" },
                          ...
                          _vm._l(_vm.countries, function(country) {
                            return _c(
                              "option",
                              {
                                domProps: {
                                  value: country.name,
                                  selected: country.name == "Indonesia"
                                }
                              },
                              [
                                _vm._v(
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.city,
                              expression: "formObject.city"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.city },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.postalCode,
                              expression: "formObject.postalCode"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.postalCode },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.telephoneNumber,
                              expression: "formObject.telephoneNumber"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.telephoneNumber },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.contactPerson1,
                              expression: "formObject.contactPerson1"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.contactPerson1 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.mobileNumber1,
                              expression: "formObject.mobileNumber1"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.mobileNumber1 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.email1,
                              expression: "formObject.email1"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "email" },
                          domProps: { value: _vm.formObject.email1 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.contactPerson2,
                              expression: "formObject.contactPerson2"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.contactPerson2 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.mobileNumber2,
                              expression: "formObject.mobileNumber2"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.mobileNumber2 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.formObject.email2,
                              expression: "formObject.email2"
                            }
                          ],
                          staticClass: "form-control",
                          attrs: { type: "email" },
                          domProps: { value: _vm.formObject.email2 },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                    ...
                    _c(
                      ...
                      [
                        ...
                        _c("input", {
                          ...
                          staticClass: "form-control",
                          attrs: { type: "text" },
                          domProps: { value: _vm.formObject.accountingNumber },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                      ...
                      [
                        ...
                        _c(
                          ...
                          _vm._l(_vm.suppliers, function(supplier, index) {
                            return _c(
                              "tr",
                              { staticClass: "filter-item-suppliers" },
                              [
                                _c("td", [_vm._v(_vm._s(supplier.id))]),
                                _vm._v(" "),
                                _c("td", [
                                  !supplier.editing && supplier.logo
                                    ? _c(
                                        "div",
                                        {
                                          staticClass: "cursor",
                                  ...
                                  !supplier.editing
                                    ...
                                    : _c("div", [
                                        _c("input", {
                                          ...
                                          domProps: { value: supplier.address }
                                        }),
                                        _vm._v(" "),
                                        _c("br"),
                                        _vm._v(" "),
                                        ...
                                        _c("input", {
                                          attrs: {
                                            ...
                                            name:
                                              "supplierPostalCode" + supplier.id
                                          },
                                          domProps: {
                                ...
                                _c("td", [
                                  !supplier.editing
                                    ? _c("span", [
                                        _vm._v(_vm._s(supplier.telephoneNumber))
                                      ])
                                    : _c("input", {
                                ...
                                _c("td", [
                                  !supplier.editing
                                    ? _c("span", [
                                        ...
                                        _vm._v(
                                          "\n                                                " +
                                            _vm._s(supplier.mobileNumber1) +
                                            " "
                                        ),
                                        _c("br"),
                                        _vm._v(
                                          "\n                                                " +
                                            _vm._s(supplier.email1) +
                                            "\n\n                                            "
                                        )
                                      ])
                                    : _c("div", [
                                        ...
                                        _c("input", {
                                          ...
                                          domProps: { value: supplier.email1 }
                                        })
                                      ])
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !supplier.editing
                                    ? _c("span", [
                                        _vm._v(
                                          "\n\n                                                " +
                                            _vm._s(supplier.contactPerson2) +
                                            " "
                                        ),
                                        _c("br"),
                                        _vm._v(
                                          "\n                                                " +
                                            _vm._s(supplier.mobileNumber2) +
                                            " "
                                        ),
                                        _c("br"),
                                        _vm._v(
                                          "\n                                                " +
                                            _vm._s(supplier.email2) +
                                            "\n\n                                            "
                                        )
                                      ])
                                    : _c("div", [
                                        ...
                                        _c("input", {
                                          ...
                                          domProps: { value: supplier.email2 }
                                        })
                                      ])
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !supplier.editing
                                    ? _c("span", [
                                        _vm._v(
                                          _vm._s(supplier.accountingNumber)
                                        )
                                      ])
                                    : _c("input", {
                                  ...
                                  supplier.isDeleted == 0
                                    ? _c("div", [
                                        ...
                                        !supplier.editing
                                          ? _c("i", {
                                              staticClass:
                                                "fa fa-pencil text-primary cursor fs-16",
                                              on: {
                                                click: function($event) {
                                                  _vm.attemptUpdateSupplier(
                                                    index
                                                  )
                                                }
                                              }
  ...
  function() {
    ...
    return _c("thead", { staticClass: "bg-master-lighter" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Address,Country")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Telephone")]),
        _vm._v(" "),
        _c(
          "th",
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Accounting No.")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Notes")]),
        _vm._v(" "),
        _c(
          "th",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-0f8c3e01", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainSuppliers.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainSuppliers.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-0f8c3e01\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainSuppliers.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainSuppliers.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f8c3e01", Component.options)
  } else {
    hotAPI.reload("data-v-0f8c3e01", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/suppliers.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainSuppliers_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainSuppliers.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainSuppliers_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainSuppliers_vue__);
/**
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/suppliers.js");
