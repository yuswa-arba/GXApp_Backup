...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainUnits.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        ...
        //get uom types
        Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["g" /* get */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'component/list/uomTypes').then(function (res) {
    ...
    methods: {
        createUnitOfMeasurement: function createUnitOfMeasurement() {
            ...
            var self = this;
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/unit', self.formObject).then(function (res) {
                if (!res.data.isFailed) {
        ...
        attemptUpdateUnit: function attemptUpdateUnit(index) {
            var self = this;
        ...
        deleteUnit: function deleteUnit(id, index) {
            ...
            if (id) {
                if (confirm('Are you sure to delete this unit?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/unit', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteUnit: function undoDeleteUnit(id, index) {
            var self = this;
            if (id) {
                if (confirm('Undo delete this unit?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/unit', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-65fe2249\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainUnits.vue":
/***/ (function(module, exports, __webpack_require__) {
                  ...
                  _c("div", { staticClass: "table-responsive" }, [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.unitOfMeasurements, function(uom, index) {
                            return _c(
                              "tr",
                              { staticClass: "filter-item-units" },
                              [
                                _c("td", [_vm._v(_vm._s(uom.id))]),
                                _vm._v(" "),
                                _c("td", [
                                  !uom.editing
                                    ? _c("span", [_vm._v(_vm._s(uom.format))])
                                    : _c("input", {
                                        attrs: {
                                          type: "text",
                                          name: "unitFormat" + uom.id
                                        },
                                        domProps: { value: uom.format }
                                      })
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !uom.editing
                                    ...
                                    : _c("input", {
                                        ...
                                        domProps: { value: uom.description }
                                      })
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !uom.editing
                                    ? _c("span", [
                                        _vm._v(_vm._s(uom.uomTypeName))
                                      ])
                                    : _c(
                                        "select",
                                        {
                                          attrs: { name: "unitTypeId" + uom.id }
                                        },
                                        _vm._l(_vm.uomTypes, function(uomType) {
                                          return _c(
                                            "option",
                                            {
                                              domProps: {
                                                value: uomType.id,
                                                selected:
                                                  uomType.id == uom.uomTypeId
                                              }
                                            },
                                            [_vm._v(_vm._s(uomType.name))]
                                          )
                                        })
                                      )
                                ]),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formObject.formatValue,
                          expression: "formObject.formatValue"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", required: "" },
                      domProps: { value: _vm.formObject.formatValue },
                      on: {
                        ...
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.formObject.uomTypeId,
                            expression: "formObject.uomTypeId"
                          }
                        ],
                        staticClass: "form-control",
                        on: {
  ...
  function() {
    ...
    return _c("thead", { staticClass: "bg-master-lighter" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Format")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-65fe2249", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainUnits.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainUnits.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-65fe2249\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainUnits.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainUnits.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-65fe2249", Component.options)
  } else {
    hotAPI.reload("data-v-65fe2249", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/units.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainUnits_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainUnits.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainUnits_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainUnits_vue__);
/**
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/units.js");
