...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemCategories.vue":
    ...
    methods: {
        createCategory: function createCategory() {
            ...
            if (self.formObject.code && self.formObject.name) {
                ...
                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/itemCategory', self.formObject).then(function (res) {
        ...
        attemptUpdateCategory: function attemptUpdateCategory(index) {

            var self = this;
            self.itemCategories[index].editing = true;
        },
        saveUpdateCategory: function saveUpdateCategory(code, index) {

            var self = this;

            var categoryName = $('input[name="' + 'categoryName' + code + '"]').val();

            if (categoryName) {

                Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/update/itemCategory', { code: code, name: categoryName }).then(function (res) {
        ...
        deleteCategory: function deleteCategory(code, index) {
            var self = this;
            if (code) {
                if (confirm('Are you sure you want to delete this category?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/itemCategory', { code: code }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteCategory: function undoDeleteCategory(code, index) {
            var self = this;
            if (code) {
                if (confirm("Undo delete this category?")) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/itemCategory', { code: code }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-3a24a725\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemCategories.vue":
/***/ (function(module, exports, __webpack_require__) {
                  ...
                  _c("div", { staticClass: "table-responsive" }, [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.itemCategories, function(category, index) {
                            return _c(
                              "tr",
                              {
                                staticClass: "filter-item-categories",
                                class: {
                                  "bg-danger-lighter": category.isDeleted
                                }
                              },
                              [
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formObject.code,
                          expression: "formObject.code"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", name: "code", required: "" },
                      domProps: { value: _vm.formObject.code },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                          }
                          _vm.$set(_vm.formObject, "code", $event.target.value)
                        }
                      }
                    })
                  ]),
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", { staticClass: "bg-master-lighter" }, [
      _c("tr", [
        _c("th", { staticClass: "text-black" }, [_vm._v("Code")]),
        _vm._v(" "),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3a24a725", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainItemCategories.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemCategories.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-3a24a725\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainItemCategories.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainItemCategories.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a24a725", Component.options)
  } else {
    hotAPI.reload("data-v-3a24a725", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/itemCategories.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainItemCategories_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainItemCategories.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainItemCategories_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainItemCategories_vue__);
/**
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/itemCategories.js");
