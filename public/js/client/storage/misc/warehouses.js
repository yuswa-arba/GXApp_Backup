...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainWarehouses.vue":
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        createWarehouse: function createWarehouse() {
            var self = this;
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/create/warehouse', self.formObject).then(function (res) {
                if (!res.data.isFailed) {
        ...
        attemptUpdateWarehouse: function attemptUpdateWarehouse(index) {
            var self = this;
            self.warehouses[index].editing = true;
        },
        saveUpdateWarehouse: function saveUpdateWarehouse(id, index) {
            var self = this;

            var warehouseName = $('input[name="' + 'warehouseName' + id + '"').val();
            var warehouseAddress = $('input[name="' + 'warehouseAddress' + id + '"').val();
            var warehouseCountry = $('select[name="' + 'warehouseCountry' + id + '"').val();
            var warehouseCity = $('input[name="' + 'warehouseCity' + id + '"').val();
            var warehousePostalCode = $('input[name="' + 'warehousePostalCode' + id + '"').val();
            var warehousePhoneNumber = $('input[name="' + 'warehousePhoneNumber' + id + '"').val();

            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/update/warehouse', {
                id: id,
                name: warehouseName,
        ...
        deleteWarehouse: function deleteWarehouse(id, index) {
            var self = this;
            if (id) {
                if (confirm('Are you sure to delete this warehouse?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/delete/warehouse', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
        ...
        undoDeleteWarehouse: function undoDeleteWarehouse(id, index) {
            var self = this;
            if (id) {
                if (confirm('Undo delete this warehouse?')) {
                    Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["h" /* post */])(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */] + 'storage/undoDelete/warehouse', { id: id }).then(function (res) {
                        if (!res.data.isFailed) {
...
/***/ "./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-90092bb4\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainWarehouses.vue":
/***/ (function(module, exports, __webpack_require__) {
...
var render = function() {
  ...
  return _c("div", { staticClass: "container-fluid container-fixed-lg" }, [
    _c("div", { staticClass: "row" }, [
      _c("div", { staticClass: "col-lg-9 m-b-10" }, [
        _c(
          "div",
          {
            staticClass:
                      ...
                      [
                        ...
                        _c(
                          ...
                          _vm._l(_vm.warehouses, function(warehouse, index) {
                            return _c(
                              "tr",
                              { staticClass: "filter-item-warehouses" },
                              [
                                _c("td", [
                                  _vm._v(
                                    "\n                                            " +
                                ...
                                _c("td", [
                                  !warehouse.editing
                                    ...
                                    : _c("input", {
                                        ...
                                        domProps: { value: warehouse.address }
                                      })
                                ]),
                                _vm._v(" "),
                                _c("td", [
                                  !warehouse.editing
                                    ...
                                    : _c("div", [
                                        ...
                                        _c("input", {
                                          attrs: {
                                            type: "text",
                                            name: "warehouseCity" + warehouse.id
                                          },
                                          domProps: { value: warehouse.city }
                                        }),
                                        _vm._v(" "),
                                        _c("input", {
                                          attrs: {
                                ...
                                _c("td", [
                                  !warehouse.editing
                                    ? _c("span", [
                                        _vm._v(_vm._s(warehouse.phoneNumber))
                                      ])
                                    : _c("input", {
                    ...
                    _c("input", {
                      ...
                      on: {
                        input: function($event) {
                          ...
                          _vm.$set(_vm.formObject, "name", $event.target.value)
                        }
                      }
                    })
                  ]),
                    ...
                    _c("input", {
                      ...
                      on: {
                        input: function($event) {
                          ...
                          _vm.$set(_vm.formObject, "city", $event.target.value)
                        }
                      }
                    })
                  ]),
                      ...
                      directives: [
                        {
                          name: "model",
                          rawName: "v-model",
                          value: _vm.formObject.phoneNumber,
                          expression: "formObject.phoneNumber"
                        }
                      ],
                      staticClass: "form-control",
                      attrs: { type: "text", required: "" },
                      domProps: { value: _vm.formObject.phoneNumber },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
  ...
  function() {
    ...
    return _c("thead", { staticClass: "bg-master-lighter" }, [
      _c("tr", [
        ...
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Address")]),
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [
          _vm._v("Country, City, Postal Code")
        ]),
        _vm._v(" "),
        _c("th", { staticClass: "text-black" }, [_vm._v("Phone")]),
        _vm._v(" "),
        _c(
          "th",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-90092bb4", module.exports)
  }
}
...
/***/ "./resources/assets/js/client/storage/misc/MainWarehouses.vue":
/***/ (function(module, exports, __webpack_require__) {

var disposed = false
var normalizeComponent = __webpack_require__("./node_modules/vue-loader/lib/component-normalizer.js")
/* script */
var __vue_script__ = __webpack_require__("./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}]],\"plugins\":[\"transform-object-rest-spread\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0&bustCache!./resources/assets/js/client/storage/misc/MainWarehouses.vue")
/* template */
var __vue_template__ = __webpack_require__("./node_modules/vue-loader/lib/template-compiler/index.js?{\"id\":\"data-v-90092bb4\",\"hasScoped\":false,\"buble\":{\"transforms\":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0&bustCache!./resources/assets/js/client/storage/misc/MainWarehouses.vue")
/* template functional */
...
Component.options.__file = "resources/assets/js/client/storage/misc/MainWarehouses.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-90092bb4", Component.options)
  } else {
    hotAPI.reload("data-v-90092bb4", Component.options)
' + '  }
...
/***/ "./resources/assets/js/client/storage/misc/warehouses.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainWarehouses_vue__ = __webpack_require__("./resources/assets/js/client/storage/misc/MainWarehouses.vue");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MainWarehouses_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__MainWarehouses_vue__);
/**
...
module.exports = __webpack_require__("./resources/assets/js/client/storage/misc/warehouses.js");
