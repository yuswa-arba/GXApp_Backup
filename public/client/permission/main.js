    ...
    methods: {
        ...
        showModal: function showModal(role) {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_0__helpers_api__["a" /* get */])(Object(__WEBPACK_IMPORTED_MODULE_1__helpers_const__["a" /* api_path */])() + 'setting/role/assigned/' + role.name).then(function (res) {
                _this2.permissions = res.data.data.allPermission.data;
                _this2.assignedPermissions = res.data.data.assignedPermission.data;
                console.log(res);
            });
...
__webpack_require__("./resources/assets/js/bootstrap.js"); // axios,lodash,etc
