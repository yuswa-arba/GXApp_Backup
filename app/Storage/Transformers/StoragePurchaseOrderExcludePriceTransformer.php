...
class StoragePurchaseOrderExcludePriceTransformer extends TransformerAbstract
{
    use GlobalUtils;
...
//    ];
    ...
    public function includePurchaseOrderItems(StoragePurchaseOrders $purchaseOrders)
    {
        ...
        return $this->collection($items, new StoragePurchaseOrderItemExcludePriceTransformer, 'items');
    }
