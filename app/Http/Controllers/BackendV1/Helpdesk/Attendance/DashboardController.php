...
class DashboardController extends Controller
{
    ...
    {
        $timesheetIn = AttendanceTimesheet::where('clockInDate',Carbon::now()->format('d/m/Y'))->whereNotNull('clockInTime')->get();
        $timesheetOut = AttendanceTimesheet::where('clockOutDate',Carbon::now()->format('d/m/Y'))->whereNotNull('clockOutTime')->get();
