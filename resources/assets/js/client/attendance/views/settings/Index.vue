        ...
        <div class="col-lg-12">
            <div class="card card-borderless">
                <ul class="nav nav-tabs nav-tabs-simple" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    <li class="nav-item">
                        <a class="active" href="#" data-toggle="tab" role="tab" data-target="#tabGeneral">General</a>
                    </li>
                    <li class="nav-item">
                        <a class="" href="#" data-toggle="tab" role="tab" data-target="#tabShifts">Shifts</a>
                    </li>
                    <li class="nav-item">
...
<script type="text/javascript">
    ...
    import GeofenceTab from '../../components/settings/GeofenceTab.vue'
    import KioskTab from '../../components/settings/KIoskTab.vue'
    import MiscTab from '../../components/settings/MiscTab.vue'
