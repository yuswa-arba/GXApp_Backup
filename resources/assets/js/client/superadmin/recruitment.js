...
$(document).ready(function () {
    ...
    createEmployeeBtn.on('click', function () {
        ...
        post(api_path + 'superAdmin/employee/create', objectToFormData(formObject))
            .then((res) => {
    ...
    saveMedicalRecordsBtn.on('click', function () {
        ...
        post(api_path + 'superAdmin/employee/medicalRecords', formData)
            .then((res) => {
    ...
    saveEmploymentBtn.on('click', function () {
        ...
        post(api_path + 'superAdmin/employee/employment', formData)
            .then((res) => {
