    ...
    <div class="login-wrapper ">
        ...
        <div class="login-container bg-white">
            <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                <img src="{{asset('core/img/logo.png')}}" alt="logo" data-src="{{asset('core/img/logo.png')}}" data-src-retina="{{asset('core/img/logo_2x.png')}}" width="78" height="22">
                ...
                <div class="pull-bottom sm-pull-bottom">
                    <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix">
                        <div class="col-sm-3 col-md-2 no-padding">
                            <img alt="" class="m-t-5" data-src="{{asset('core/img/pages_icon.png')}}" data-src-retina="{{asset('core/img/pages_icon_2x.png')}}" height="60" src="{{asset('core/img/pages_icon.png')}}" width="60">
                        </div>
